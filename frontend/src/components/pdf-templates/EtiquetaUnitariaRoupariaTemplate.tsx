	...
	return (
		<>
			<View style={styles.rowHeader}>
				...
				{ShowTemperatura(conteudo?.temperatura, 4)}
			</View>
...
export const EtiquetaUnitariaRoupariaTemplate = (conteudo: DataEtiqueta) => {
	Font.register({
		family: `Lato`,
		src: Lato,
	})
