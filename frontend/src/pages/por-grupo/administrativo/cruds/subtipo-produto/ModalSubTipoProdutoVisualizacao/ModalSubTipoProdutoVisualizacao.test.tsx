...
import { ModalSubTipoProdutoVisualizacao } from './intex'
...
describe(`ModalSubTipoProdutoVisualizacao [caixa branca]`, () => {
	it(`Visualizar modal em tela => permanecer estável`, async () => {
		...
		await waitFor(() => {
			expect(screen.getByText(`Sub Tipo`)).toBeInTheDocument()
		})
