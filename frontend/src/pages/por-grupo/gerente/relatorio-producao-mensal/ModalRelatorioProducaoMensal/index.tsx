...
import { RelatorioProducaoMensalPDF } from "@/components/pdf-templates/Relatorios/RelatorioProducaoMensal"

export function ModalRelatorioProducaoMensal({ visible, onClose, data, datasRange }: any) {
	const {
		exportExcel,
		exportCSV,
		exportODS,
	...
	return (
		...
		>
			<div className="h-auto">
				<DataTable
					value={data?.data?.preparos_por_cliente ?? []}
					emptyMessage='Nenhum dado encontrado.'
					stripedRows
					scrollHeight={`100%`}
				>
					<Column
						field='cliente__nomecli'
						header="Cliente"
			...
			<PDFDownloadLink
				...
				document={<RelatorioProducaoMensalPDF {...props} />}
