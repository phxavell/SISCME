...
import {TitlesCards} from "../types.ts"
...
import '../style.css'
import {
	IPropsCadastrarCaixasTermo,
	MessageType
} from "@pages/por-grupo/tecnico-cme/processos/termo/modal-termo/types.ts"
import { makeShowMessage } from "../../../termo/modal-termo/helps.tsx"
...
export const CadastrarCaixasEsterilizacao: React.FC<IPropsCadastrarCaixasTermo> = (props) => {
	const {
		caixasDisponiveis,
	...
	const showMessage = makeShowMessage(msgs)
	...
	const handleClickAdicionar = () => {
		if (serial) {
			...
			toastError(`Serial não informado.`)
		}
		...
		<Card
			...
			<div className={`${styleSectionBorderTerm} -mt-5 flex-grow-1`}>
				...
				<div className="text-left flex-wrap">
					<div className=" flex gap-2 mt-2 border-noround">
						<InputText
							autoFocus
							id="serial"
							placeholder="Serial"
